...
<h2 style="font-family:Georgia,serif;color:#3a4d39;font-size:22px;margin:0 0 16px;">Rapport de suivi T${trimestre} ${annee}</h2>
...
<p style="color:#6b7f6a;font-size:13px;margin:28px 0 0;">AMANA Patrimoine est CIF/COA/COBSP enregistré à l'ORIAS sous le n° 25009552.</p>
</td></tr>
<tr><td style="background:#f8f4ec;padding:20px 40px;border-top:1px solid #e8dfc8;"><p style="margin:0;font-size:12px;color:#6b7f6a;">Cet email a été envoyé automatiquement.</p></td></tr>
