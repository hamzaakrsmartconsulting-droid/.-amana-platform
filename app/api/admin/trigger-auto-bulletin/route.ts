// app/api/admin/trigger-auto-bulletin/route.ts
// Route proxy sécurisée : l'UI admin déclenche auto-bulletin après V7 (ra_bulletin_send)
...
export async function POST(request: NextRequest) {
  ...
  const res = await fetch(`${base}/api/dossiers/${dossier_id}/auto-bulletin`, {
    method: 'POST',
