...
interface Product {
  ...
  halal_certifie:      boolean  // champ interne — ne pas afficher publiquement
  actif:               boolean
  risque_sri?:         number
    ...
    >
      ...
      <div style={{ padding: '20px 20px 16px', borderBottom: '1px solid #f0ece4' }}>
        <div style={{
          ...
          {/* Badge halal supprimé — sera réactivé après certification officielle */}
        </div>
        <h3 style={{
          fontFamily: "'Cormorant Garamond', Georgia, serif",
          fontSize: 18, color: FOREST, margin: '0 0 3px', fontWeight: 500,
          lineHeight: 1.25,
        }}>
          {p.nom}
        </h3>
        <div style={{
          fontSize: 12, color: '#8a9a89',
          fontFamily: "'Inter', system-ui, sans-serif",
        }}>
          {p.gestionnaire}
        </div>
      ...
      <div style={{ padding: '14px 20px', flex: 1 }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10 }}>
          <div>
            <div style={{
              fontSize: 9, color: '#8a9a89', textTransform: 'uppercase',
          ...
          <div>
            ...
            <div style={{
              fontFamily: "'Cormorant Garamond', Georgia, serif",
              fontSize: 16, fontWeight: 600, color: FOREST,
            }}>
          ...
          <div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
            {p.risque_sri && (
              <span style={{
                ...
                background: '#f0f0f0', color: '#6a7a69', fontWeight: 500,
                fontFamily: "'Inter', system-ui, sans-serif",
              }}>
                SRI {p.risque_sri}/7
              </span>
  ...
  return (
    <div style={{ minHeight: '100vh', background: CREAM, fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '24px 16px 72px' }}>
        ...
        {!kyc && !loading && (
          <div style={{
            background: 'white', border: '1px solid #e8d8a0',
            ...
            <div style={{ flex: 1 }}>
              <div style={{
                fontFamily: "'Cormorant Garamond', Georgia, serif",
                fontSize: 16, color: FOREST, fontWeight: 500, marginBottom: 2,
              }}>
                Dossier KYC requis
              </div>
            ...
            <a href="/kyc" style={{
              padding: '8px 14px', background: FOREST, color: 'white',
        ...
        {/* Filter chips — type uniquement, filtre halal supprimé */}
        ...
        {/* Product grid */}
        {loading ? (
          <div style={{ textAlign: 'center', padding: '60px 0', color: '#8a9a89', fontSize: 14 }}>
          ...
          <div style={{
            ...
            background: 'white', borderRadius: 16, border: '1px solid #e8e0d0',
          }}>
            ...
            <button onClick={() => setFilter('Tous')} style={{
              marginTop: 4, padding: '9px 20px', background: FOREST, color: 'white',
        ...
        <div style={{
          ...
          background: 'white', borderRadius: 10, border: '1px solid #e8e0d0',
        }}>
