        ...
        {!loading && !error && (
          <>
            ...
            {filtered.length === 0 ? (
              ...
              <div className="conseiller-table-wrap" style={{ background: 'white', borderRadius: '14px', boxShadow: '0 2px 12px rgba(68,75,63,0.06)', border: '1px solid #e8e0d0' }}>
                <table className="conseiller-table" style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
